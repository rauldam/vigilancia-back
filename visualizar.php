...
$producto = $cliente->get_producto($idprod);

$rutas = send_curl('https://test.serviciosdeconsultoria.es/obtenerRutas.php',$cif,$producto[1][0]['tipo_producto'],$redName,$producto[1][0]['anyo']);

function send_curl($url,$cif,$prod,$redName,$anyo){
   $ch = curl_init();
   curl_setopt($ch, CURLOPT_URL, $url.'?cif='.$cif.'&prod='.$prod.'&red='.$redName.'&anyo='.$anyo); 
   curl_setopt($ch, CURLOPT_RETURNTRANSFER, true); 
   curl_setopt($ch, CURLOPT_HEADER, 0); 
   $rutas =  curl_exec($ch);
   $rutasArray = array();
   $rutasArray = json_decode($rutas,true);
   curl_close($ch);
        ...
        <div class="container-fluid">
          ...
          <div class="title-wrapper pt-30">
            <div class="row align-items-center">
              <div class="col-md-6">
                <div class="title">
                  <h2><?php echo strtoupper($producto[1][0]['tipo_producto']) ?></h2>
                </div>
              </div>
              <!-- end col -->
              <div class="col-md-6">
                  ...
                  <nav aria-label="breadcrumb">
                    <ol class="breadcrumb">
                      ...
                      <li class="breadcrumb-item active" aria-current="page">
                        <?php echo $producto[1][0]['tipo_producto'] ?>
                      </li>
                    </ol>
                  </nav>
                </div>
                    ...
                    echo ('
                        ...
                        <div class="card" style="">
                          <div class="card-header">
                            <h5 class="card-title">'.$rutas[$i+2].'</h5>
                          </div>
                          <div class="card-body" align="center">
                              <iframe src="https://docs.google.com/viewer?url=test.serviciosdeconsultoria.es/users/'.$cif.'/'.$redName.'/'.strtoupper($producto[1][0]['tipo_producto']).'/'.$producto[1][0]['anyo'].'/'.$rutas[$i+2].'&embedded=true" style="width:300px; height:350px;" frameborder="0"></iframe>
                          </div>
                          <div class="card-footer" align="center">
                            <a href="https://test.serviciosdeconsultoria.es/users/'.$cif.'/'.$redName.'/'.strtoupper($producto[1][0]['tipo_producto']).'/'.$producto[1][0]['anyo'].'/'.$rutas[$i+2].'" class="card-link" target="_blank">Descargar este archivo</a>
                          </div>
                        </div>
                        <br>
                        <br>
